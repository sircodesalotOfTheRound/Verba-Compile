...
public class CallFrame {
  ...
  public int workingRegister() {
    return this.workingRegister;
  }

  private void setWorkingRegister(int workingRegister) {
    this.workingRegister = workingRegister;
  }

  public void incrementWorkingRegister() {
    this.workingRegister++;
  }

  public void decrementWorkingRegister() {
    this.workingRegister--;
  }
}
